    ...
    return Scaffold(
      ...
      appBar: AppBar(automaticallyImplyLeading: false,
          ...
          title: Center( 
            child: Column( 
              children: [  Text(
              "Vegetables",textAlign: TextAlign.center,
